...
public class LogIn extends javax.swing.JFrame {
    private boolean realtorMode = false;
    
    /**
     * Creates new form LogI
     */
    public LogIn(boolean mode) {
        initComponents();
        this.realtorMode = mode;
    }
    ...
    private void logInEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logInEnterActionPerformed
        ...
        Transaction transact = new Transaction(username.getText(), password.getPassword(), this.realtorMode);
        this.dispose();
